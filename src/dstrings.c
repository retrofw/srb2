...
#ifdef GCW0
	"Press START (yes) or SELECT (no).",                                                               //PRESSYN
#else
...
#ifdef GCW0
	"Are you sure you want to end the game?\n\npress start(Y) or select(N).",                     //ENDGAME
#else
	"Are you sure you want to end the game?\n\npress Y or N.",                     //ENDGAME
#endif
#ifdef GCW0
	"%s\n\n(Press START to quit)",                                            //DOSY
#else
...
#ifdef GCW0
	"Hit the 'SELECT' key, Sonic!\nThe 'SELECT' key!",               //QUIT2MSG6
#else
	"Hit the 'N' key, Sonic!\nThe 'N' key!",               //QUIT2MSG6
#endif
...
#ifdef GCW0
	"Every time you press START (YES), an\nSRB2 Developer cries...",                        //QUIT3MSG4
#else
